...
<header class="site-header" role="banner">
    ...
    <nav class="site-nav" aria-label="Primary">
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/staff" class="active">Staff</a></li>
...
<main role="main" class="main-content">
    <section class="card" aria-labelledby="staff-list">
        <div class="section-header">
            <h2 id="staff-list">All Staff</h2>
        </div>
        <c:choose>
                ...
                <div class="responsive-table" role="region" aria-live="polite">
                    <table>
                        ...
                        <c:forEach var="staffMember" items="${staff}">
                            <tr>
                                <td><c:out value="${staffMember.id}"/></td>
                                <td><c:out value="${staffMember.fullName}"/></td>
                                <td><c:out value="${staffMember.email}"/></td>
                                <td><c:out value="${staffMember.phoneNumber}"/></td>
                                <td><c:out value="${staffMember.employmentDate}"/></td>
                                <td><c:out value="${staffMember.department}"/></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
            ...
            <c:otherwise>
                <p class="empty-state">No staff members added yet.</p>
            </c:otherwise>
        </c:choose>
    </section>
</main>
