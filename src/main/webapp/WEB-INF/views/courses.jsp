...
<head>
    <meta charset="UTF-8">
    <title>School Management – Courses</title>
    <style>
        :root {
            color-scheme: light;
            --bg: #eef2ff;
...
<main role="main" class="main-content">
    <section class="card" aria-labelledby="courses-list">
        <div class="section-header">
            <h2 id="courses-list">All Courses</h2>
        </div>
        <c:choose>
                    ...
                    <table>
                        ...
                        <c:forEach var="course" items="${courses}">
                            <tr>
                                ...
                                <td><c:out value="${course.weeklyDuration.toHours()}"/></td>
                                <td><c:out value="${course.teacherId != null ? course.teacherId : 'Unassigned'}"/></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
