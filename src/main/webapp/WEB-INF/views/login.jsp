...
<head>
    <meta charset="UTF-8">
    <title>School Management – Sign In</title>
    <style>
        :root {
            color-scheme: light;
            --bg: #eef2ff;
...
<main role="main" class="auth-main">
    <section class="card" aria-labelledby="login-heading">
        ...
        <p class="hint">Use your administrator or staff credentials.</p>
        ...
        <form method="post" action="${pageContext.request.contextPath}/login" novalidate>
            ...
            <div class="actions">
                ...
                <a class="secondary-link" href="${pageContext.request.contextPath}/signup">Need an account?</a>
            </div>
        </form>
    </section>
</main>
